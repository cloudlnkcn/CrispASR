...
| **melotts** | [`myshell-ai/MeloTTS`](https://github.com/myshell-ai/MeloTTS) EN_V2 | VITS2 (6L transformer + SDP/DP + transformer coupling flow + HiFi-GAN); 44.1 kHz, ~102 MB + optional 238 MB BERT companion; neural G2P; 4 EN speakers ([more](docs/architecture.md#melotts)) | en | MIT |
