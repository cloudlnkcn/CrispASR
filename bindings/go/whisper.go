...
#cgo LDFLAGS: -L${SRCDIR}/../../build/src -L${SRCDIR}/../../build/crisp_audio -L${SRCDIR}/../../build/crisp_lid -L${SRCDIR}/../../build/crisp_punc -L${SRCDIR}/../../build/crisp_truecase -L${SRCDIR}/../../build/ggml/src -L${SRCDIR}/../../build/_deps/crispasr_ogg-build -L${SRCDIR}/../../build/_deps/crispasr_opus-build -L${SRCDIR}/../../build/_deps/crispasr_opencore_amr-build
#cgo LDFLAGS: -L${SRCDIR}/../../build_go/src -L${SRCDIR}/../../build_go/crisp_audio -L${SRCDIR}/../../build_go/crisp_lid -L${SRCDIR}/../../build_go/crisp_punc -L${SRCDIR}/../../build_go/crisp_truecase -L${SRCDIR}/../../build_go/ggml/src -L${SRCDIR}/../../build_go/_deps/crispasr_ogg-build -L${SRCDIR}/../../build_go/_deps/crispasr_opus-build -L${SRCDIR}/../../build_go/_deps/crispasr_opencore_amr-build
...
#cgo linux LDFLAGS: -Wl,--start-group -lggml-base -lggml-cpu -lggml -lcrispasr-core -ltada-codec -lcrisp_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lopus -logg -lzonos-tts -lwav2vec2-ggml -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsensevoice -lqwen3_tts -lomnivoice -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomniasr -lnemotron -lmoss_transcribe -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lirodori-tts -lindextts -lhiggs_stt -lgranite_speech -lgranite_nle -lglm-asr -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldots-tts -ldia-tts -lctc-align -lcsm-tts -lcrispasr_opusfile -lcrispasr-vad-encdec -lcrispasr-llama-core -lcrisp_truecase -lcrisp_punc -lcrisp_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_ctc -lcanary -lbark-tts -lbananamind-tts -laudioseal -lark_asr -lcrispasr -Wl,--end-group -lm -lstdc++ -fopenmp
#cgo darwin LDFLAGS: -lggml-base -lggml-cpu -lggml -lcrispasr-core -ltada-codec -lcrisp_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lopus -logg -lzonos-tts -lwav2vec2-ggml -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsensevoice -lqwen3_tts -lomnivoice -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomniasr -lnemotron -lmoss_transcribe -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lirodori-tts -lindextts -lhiggs_stt -lgranite_speech -lgranite_nle -lglm-asr -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldots-tts -ldia-tts -lctc-align -lcsm-tts -lcrispasr_opusfile -lcrispasr-vad-encdec -lcrispasr-llama-core -lcrisp_truecase -lcrisp_punc -lcrisp_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_ctc -lcanary -lbark-tts -lbananamind-tts -laudioseal -lark_asr -lcrispasr -lm -lstdc++
