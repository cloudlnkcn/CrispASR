...
try:
    ...
    sys.exit("tada not found: pip install git+https://github.com/HumeAI/tada.git")
...
def encode_and_save(audio: np.ndarray, transcript: str, lang: str,
    ...
    encoder = Encoder.from_pretrained(CODEC_REPO, subfolder="encoder",
                                      language=lang).to(device)
    encoder.eval()
